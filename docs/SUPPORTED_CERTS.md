...
| 사회조사분석사 1급 | SSA-1 | `sociostat1` | 한국산업인력공단 | https://www.q-net.or.kr/ | 필기 100% / 실기 작업형 | 🟡 |
| 사회조사분석사 2급 | SSA-2 | `sociostat2` | 한국산업인력공단 | https://www.q-net.or.kr/ | 필기 100% / 실기 작업형 | 🟡 |
| 개인정보관리사 | CPPG | `cppg` | 한국CPO포럼 (KISA 공인) | https://www.cpptest.or.kr/ | 100% (100문항) | 🟢 |
| SMAT 서비스경영자격 A·B·C | SMAT | `smatA`/`smatB`/`smatC` | 한국생산성본부 | https://license.kpc.or.kr/ | 100% | 🟢 |
| CS Leaders 관리사 | CS-L | `csleaders` | 한국정보통신진흥협회 (KAIT) | https://www.kait.or.kr/ | 100% | 🟢 |
| 텔레마케팅관리사 | TMM | `telemkt` | 한국산업인력공단 | https://www.q-net.or.kr/ | 필기 100% | 🟢 |
| 컴퓨터그래픽스운용기능사 | CGF | `cgf` | 한국산업인력공단 | https://www.q-net.or.kr/ | 필기 100% | 🟢 |
...
| Python Institute PCEP | PCEP | `pcep` | OpenEDG Python Institute | https://pythoninstitute.org/pcep | 100% | 🟢 |
| Python Institute PCAP | PCAP | `pcap` | OpenEDG Python Institute | https://pythoninstitute.org/pcap | 100% | 🟢 |
| ISTQB Foundation (CTFL) | CTFL | `istqb-f` | ISTQB | https://www.istqb.org/ | 100% (40문항) | 🟢 |
| CAPM (Certified Associate in PM) | CAPM | `capm` | PMI | https://www.pmi.org/certifications/certified-associate-capm | 100% | 🟢 |
| PRINCE2 Foundation | P2-F | `prince2-f` | PeopleCert (AXELOS) | https://www.peoplecert.org/ | 100% | 🟢 |
| CBAP (비즈니스 분석) | CBAP | `cbap` | IIBA | https://www.iiba.org/business-analysis-certifications/ | 100% (120문항) | 🟢 |
| ECBA (입문 BA) | ECBA | `ecba` | IIBA | https://www.iiba.org/business-analysis-certifications/ | 100% | 🟢 |
| TOGAF Foundation | TOGAF-F | `togaf-f` | The Open Group | https://www.opengroup.org/certifications/togaf | 100% | 🟢 |
| CEH (Ethical Hacker) | CEH | `ceh` | EC-Council | https://www.eccouncil.org/train-certify/certified-ethical-hacker-ceh/ | 100% (125문항) | 🟢 |
| CCSK (Cloud Security Knowledge) | CCSK | `ccsk` | Cloud Security Alliance | https://cloudsecurityalliance.org/education/ccsk | 100% (60문항) | 🟢 |
| HashiCorp Terraform Associate | HC-TA | `hc-terraform` | HashiCorp | https://www.hashicorp.com/certification | 100% | 🟢 |
| Databricks Data Engineer Associate | DBX-DEA | `dbx-de-a` | Databricks | https://www.databricks.com/learn/certification | 100% (45문항) | 🟢 |
| Salesforce Administrator | SF-Admin | `sf-admin` | Salesforce | https://trailhead.salesforce.com/credentials/administrator | 100% | 🟢 |
| Tableau Desktop Specialist | TDS | `tableau-ds` | Tableau / Salesforce | https://www.tableau.com/learn/certification | 100% | 🟢 |
| SAS Base Programmer | SAS-Base | `sas-base` | SAS Institute | https://www.sas.com/en_us/certification/ | 100% | 🟢 |
| TensorFlow Developer Certificate | TF-Dev | `tfdev` | Google | https://www.tensorflow.org/certificate | 실기(코딩) | ⚪ |
| AWS Machine Learning – Specialty | MLS-C01 | `aws-mls` | AWS | https://aws.amazon.com/certification/ | 100% | 🟢 |
| Azure AI Engineer (AI-102) | AI-102 | `az-ai-102` | Microsoft | https://learn.microsoft.com/credentials/ | 100% | 🟢 |
| Microsoft Fabric Analytics Engineer (DP-600) | DP-600 | `dp-600` | Microsoft | https://learn.microsoft.com/credentials/ | 100% | 🟢 |
| Azure Data Engineer (DP-203) | DP-203 | `dp-203` | Microsoft | https://learn.microsoft.com/credentials/ | 100% | 🟢 |
| Google Cloud Professional ML Engineer | GCP-PMLE | `gcp-pmle` | Google Cloud | https://cloud.google.com/certification | 100% | 🟢 |
| Oracle Cloud Infrastructure Foundations | OCI-F | `oci-found` | Oracle | https://education.oracle.com/ | 100% | 🟢 |
| MOS (Microsoft Office Specialist) | MOS | `mos` | Certiport / Microsoft | https://www.certiport.com/ | 실기(프로그램 조작) | ⚪ |
...
| 재경관리사 | `jaegyeong` | 삼일회계법인 | https://license.samili.com/ | 100% (객관식) | 🟢 |
| 회계관리 1급 | `acctmgr1` | 삼일회계법인 | https://license.samili.com/ | 100% (객관식) | 🟢 |
| 회계관리 2급 | `acctmgr2` | 삼일회계법인 | https://license.samili.com/ | 100% (객관식) | 🟢 |
...
| JPT (일본어능력시험) | `jpt` | YBM | https://www.jpt.co.kr/ | 100% (LC/RC 200문항) | 🟢 |
| BJT (비즈니스 일본어) | `bjt` | 일본한자능력검정협회 | https://bjt.jp/ | 100% | 🟢 |
...
| 외환전문역 1종 | `forex-expert1` | 한국금융연수원 | https://www.kbi.or.kr/ | 100% | 🟢 |
| 외환전문역 2종 | `forex-expert2` | 한국금융연수원 | https://www.kbi.or.kr/ | 100% | 🟢 |
| KBI 금융DT | `kbi-fdt` | 한국금융연수원 | https://www.kbi.or.kr/ | 100% | 🟢 |
| TESAT (한경 경제이해력검증) | `tesat` | 한국경제신문 | https://www.tesat.or.kr/ | 100% (80문항) | 🟢 |
| 매경TEST | `mktest` | 매일경제신문 | https://exam.mk.co.kr/ | 100% (80문항) | 🟢 |
| 변액보험판매관리사 | `vlib` | 생명보험협회 | https://www.klia.or.kr/ | 100% (40문항) | 🟢 |
...
| 보세사 | `bonded` | 한국관세무역개발원 | https://www.conex.or.kr/ | 100% (5과목 125문항) | 🟢 |
...
| 경비지도사 1차 (일반·기계) | `secguard1` | 한국산업인력공단 | https://www.q-net.or.kr/ | 100% (객관식) | 🟢 |
| 경비지도사 2차 (일반·기계) | `secguard2` | 한국산업인력공단 | https://www.q-net.or.kr/ | 100% (객관식) | 🟢 |
...
| 경영지도사 1차 (인사·재무·생산·마케팅) | `mgmtcons1` | 한국산업인력공단 | https://www.q-net.or.kr/ | 객관식 | 🟢 |
| 경영지도사 2차 | `mgmtcons2` | 한국산업인력공단 | https://www.q-net.or.kr/ | 논술 | ⚪ |
| 기술지도사 1차 | `techcons1` | 한국산업인력공단 | https://www.q-net.or.kr/ | 객관식 | 🟢 |
| 기술지도사 2차 | `techcons2` | 한국산업인력공단 | https://www.q-net.or.kr/ | 논술 | ⚪ |
...
> 공식 URL 도달 가능 여부는 **GitHub Actions가 매주 월요일 자동 검증**합니다.
> 로컬에서 즉시 검증: `npm run check:catalog` (산출: `docs/cert-urls-report.json`)

검증 항목:
- [ ] 공식 URL 응답 확인 (도메인 변경/이전 추적) — *자동화 완료*
...
- 삼일회계법인 (재경관리사·회계관리): https://license.samili.com/
- 한국관세무역개발원 (보세사): https://www.conex.or.kr/
- 한국경제신문 TESAT: https://www.tesat.or.kr/
- 매일경제 매경TEST: https://exam.mk.co.kr/
- 생명보험협회 (변액보험판매관리사): https://www.klia.or.kr/
- 한국CPO포럼 (CPPG): https://www.cpptest.or.kr/
- 한국정보통신진흥협회 KAIT: https://www.kait.or.kr/
- 한국생산성본부 KPC (SMAT·ERP·GTQ·ITQ): https://license.kpc.or.kr/
- 와우내일배움카드 (와나에카, 국민내일배움카드 교육 플랫폼): https://hrd.wowpass.com/
